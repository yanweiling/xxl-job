...
public class ExecutorBizClient implements ExecutorBiz {
    ...
    public ReturnT<String> run(TriggerParam triggerParam) {
        System.out.println("ExecutorBizClient....run....");
        System.out.println("XxlJobRemotingUtil.postBody,url="+addressUrl+"run"+"");
        System.out.println("XxlJobRemotingUtil.postBody,triggerParam="+triggerParam);
